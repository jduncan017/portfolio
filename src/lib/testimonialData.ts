...
export const TESTIMONIAL_DATA: TestimonialData[] = [
  {
    ...
    industry. Specifically, I would like to highlight his skillset in the following areas:
    ...
    **Problem Solving:**
    ...
    a shuttered operation to a highly sought-after establishment due to Josh’s decisions and problem-solving. 
    ...
    **Teamwork and Collaboration:**
    ...
    team members were welcomed, creating an innovative and enriching organizational environment that positively impacted our customers.


    **Organized Innovation and Creativity:**
    ...
    became a nationally recognized establishment, solidifying its position in the industry.
    ...
    for any role requiring strategic thinking and leadership.
...
`,
  ...
  },
  {
    ...
    enthusiastic about providing a recommendation. Initially seeking a simple website for our woodworking business—a landing page for showcasing 
  ...
  },
  {
    ...
    I gave up the idea of building it alone, and was referred to Josh through my friend Marc.
    ...
    always fast, and I never waited longer than a couple hours to hear back from him.
