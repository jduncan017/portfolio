export const resumeData = {
  ...
  bioDescription2:
    "I enjoy the challenges of being a developer and the ability to create modern applications using tools like TypeScript, React, Next.js, Node.js, HTML5, and CSS3 (to name a few <skillsLink>).",
  education: {
