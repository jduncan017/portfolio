...
export default function TestimonialSection() {
  return (
    ...
    >
      ...
      <div className="BorderWrapper shadow-customBright flex w-full justify-center border-y-4 border-double border-gray-500 bg-gradient-to-br from-black via-gray-900 py-16 ">
