  ...
  return (
    <nav className="NavBar fixed left-0 right-0 top-0 z-40">
      ...
      <div className="DesktopNav fixed z-50 hidden w-full sm:block">
        ...
        <div
          className={`DesktopNavBackground h-12 w-full border-b border-gray-800 bg-gradient-to-b from-offBlack via-gray-900 to-offBlack shadow-2xl transition-all duration-500 ${
